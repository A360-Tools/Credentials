...
public class GetDynamicCredentialAttributes {
    ...
    public DictionaryValue execute(
            ...
            @Idx(index = "3", type = AttributeType.SELECT, options = {
                    @Idx.Option(index = "3.1", pkg = @Pkg(label = "[[GetDynamicCredAttributes.authType.currentUser.label]]", value = "user")),
                    @Idx.Option(index = "3.2", pkg = @Pkg(label = "[[GetDynamicCredAttributes.authType.specificUser.label]]", value = "authenticate"))})
            @Pkg(label = "[[GetDynamicCredAttributes.authType.label]]", description = "[[GetDynamicCredAttributes.authType.description]]",
            ...
            @Idx(index = "3.2.2", type = AttributeType.RADIO, options = {
                    @Idx.Option(index = "3.2.2.1", pkg = @Pkg(label = "[[GetDynamicCredAttributes.authMethod.password.label]]", value = "password")),
                    @Idx.Option(index = "3.2.2.2", pkg = @Pkg(label = "[[GetDynamicCredAttributes.authMethod.apiKey.label]]", value = "apikey"))})
            ...
            @Idx(index = "3.2.4", type = AttributeType.SELECT, options = {
                    @Idx.Option(index = "3.2.4.1", pkg = @Pkg(label = "[[GetDynamicCredAttributes.CRType.currentCR.label]]", value = "current")),
                    @Idx.Option(index = "3.2.4.2", pkg = @Pkg(label = "[[GetDynamicCredAttributes.CRType.specificCR.label]]", value = "specific"))})
            @Pkg(label = "[[GetDynamicCredAttributes.CRType.label]]", default_value = "current", default_value_type = DataType.STRING)
            @NotEmpty
